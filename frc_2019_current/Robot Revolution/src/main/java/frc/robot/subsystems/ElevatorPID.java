...
public class ElevatorPID extends Subsystem{
    ...
    private final int MID_POSITION_PRESET = 10000; // CHANGE
    ...
    private final double CURRENT_CAP = 20;
    ...
    public void liftInit(){
        ...
        */
        ...
        /* PID settings */
        lift.configMotionAcceleration(4000);
        lift.configMotionCruiseVelocity(1500);
        lift.config_kF(0, 0);
        lift.config_kP(0, 3);
        lift.config_kI(0, .003);
    ...
    public void lift(){
        ...
        // }
        if(lift.getOutputCurrent() > CURRENT_CAP){
            lift.set(ControlMode.PercentOutput, 0);
        }
        else if(OI.getIntakeTrigger("left") > .20){
        ...
        // }
         ...
         SmartDashboard.putString("DB/String 0", "Lift Current: " + lift.getOutputCurrent());
